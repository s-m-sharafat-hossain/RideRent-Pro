...
<div class="dashboard-container">
    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="<?= APP_BASE_URL ?>/customer/vehicles" style="display: grid; grid-template-columns: 1fr 1fr auto auto; gap: 15px; align-items: end;">
                    ...
                    <a href="<?= APP_BASE_URL ?>/customer/vehicles" class="btn btn-secondary"><i class="fas fa-redo"></i> Reset</a>
                </form>
            </div>
        </div>
                    ...
                    <div class="vehicle-card">
                        ...
                        <div class="vehicle-info">
                            ...
                            <div style="display: flex; gap: 10px;">
                                <a href="<?= APP_BASE_URL ?>/customer/book-vehicle?id=<?= $row['vehicle_id']; ?>" class="btn btn-primary" style="flex: 1;">Book Now</a>
                                <a href="<?= APP_BASE_URL ?>/customer/compare?add=<?= $row['vehicle_id']; ?>" class="btn btn-secondary"><i class="fas fa-balance-scale"></i></a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
