        ...
        if(mysqli_num_rows($check_result) > 0) {
            ...
            switch($role) {
                case 'customer':
                    ...
                    $redirect = "/RideRentPro/customer/dashboard.php";
                    break;
                case 'driver':
                    $insert_sql = "INSERT INTO driver (full_name, username, email, password, phone) VALUES ('$full_name', '$username', '$email', '$password', '$phone')";
                    $redirect = "/RideRentPro/driver/dashboard.php";
                    break;
                case 'owner':
                    $insert_sql = "INSERT INTO vehicle_owner (full_name, username, email, password, phone) VALUES ('$full_name', '$username', '$email', '$password', '$phone')";
                    $redirect = "/RideRentPro/owner/dashboard.php";
                    break;
                case 'admin':
                    $insert_sql = "INSERT INTO admin (full_name, username, email, password, phone) VALUES ('$full_name', '$username', '$email', '$password', '$phone')";
                    $redirect = "/RideRentPro/admin/dashboard.php";
                    break;
            }
...
<div class="form-container" style="max-width: 600px;">
    ...
    <div style="text-align: center; margin-top: 25px;">
        <p style="color: var(--medium-gray);">
            ...
            <a href="/RideRentPro/auth/login.php" style="color: var(--maya-blue); text-decoration: none; font-weight: 600;">Login here</a>
        </p>
    </div>
</div>
