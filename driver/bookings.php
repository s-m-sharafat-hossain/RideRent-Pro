 ...
 * 
 * This view displays the booking history for the current driver.
 * It shows all bookings assigned to the driver with their status and details.
 * 
 * @package RideRentPro\Views\Driver
 * @author RideRent Pro Team
 * @version 1.0.0
 * 
 * @var array $bookings Array of booking records with vehicle and customer information
...
<div class="dashboard-container">
    ...
    <div class="main-content">
        <div class="page-header">
            ...
            <p>View and manage your assigned bookings</p>
        </div>
